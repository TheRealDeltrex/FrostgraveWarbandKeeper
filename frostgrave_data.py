...
SPELLS: dict[str, list[dict]] = {
    "Chronomancer": [
        {"name": "Crumble", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Decay", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Fast Act", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Fleet Feet", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Petrify", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Slow", "cn": 10, "type": "Line of Sight (sight)"},
    ...
    "Elementalist": [
        ...
        {"name": "Elemental Ball", "cn": 12, "type": "Line of Sight (16\")"},
        {"name": "Elemental Bolt", "cn": 12, "type": "Line of Sight (16\")"},
        {"name": "Elemental Hammer", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Elemental Shield", "cn": 10, "type": "Self Only"},
        {"name": "Scatter Shot", "cn": 12, "type": "Area Effect"},
        {"name": "Wall", "cn": 10, "type": "Line of Sight (10\")"},
    ],
    "Enchanter": [
        {"name": "Animate Construct", "cn": 10, "type": "Out of Game (B)"},
        {"name": "Control Construct", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Embed Enchantment", "cn": 14, "type": "Out of Game (A)"},
        {"name": "Enchant Armour", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Enchant Weapon", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Grenade", "cn": 10, "type": "Line of Sight (14\")"},
        {"name": "Strength", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Telekinesis", "cn": 10, "type": "Line of Sight (16\")"},
    ],
    "Illusionist": [
        {"name": "Beauty", "cn": 10, "type": "Self Only"},
        {"name": "Blink", "cn": 12, "type": "Line of Sight (12\")"},
        {"name": "Fool's Gold", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Glow", "cn": 10, "type": "Line of Sight (sight)"},
        ...
        {"name": "Transpose", "cn": 12, "type": "Line of Sight (sight)"},
    ],
    "Necromancer": [
        {"name": "Animate Skull", "cn": 8, "type": "Line of Sight (6\")"},
        {"name": "Bone Dart", "cn": 10, "type": "Line of Sight (12\")"},
        {"name": "Bones of the Earth", "cn": 10, "type": "Line of Sight (18\")"},
        {"name": "Control Undead", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Raise Zombie", "cn": 10, "type": "Out of Game (B) / Touch"},
        {"name": "Spell Eater", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Steal Health", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Strike Dead", "cn": 18, "type": "Line of Sight (8\")"},
    ],
    "Sigilist": [
        {"name": "Absorb Knowledge", "cn": 12, "type": "Out of Game (A)"},
        {"name": "Bridge", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Draining Word", "cn": 14, "type": "Area Effect"},
        {"name": "Explosive Rune", "cn": 10, "type": "Line of Sight (4\")"},
        {"name": "Furious Quill", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Power Word", "cn": 14, "type": "Area Effect"},
        {"name": "Push", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Write Scroll", "cn": 12, "type": "Out of Game (A)"},
    ],
    "Soothsayer": [
        {"name": "Awareness", "cn": 12, "type": "Out of Game (B)"},
        {"name": "Combat Awareness", "cn": 12, "type": "Touch"},
        {"name": "Mind Control", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Mind Lock", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Reveal Secret", "cn": 12, "type": "Out of Game (B)"},
        {"name": "Suggestion", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "True Sight", "cn": 10, "type": "Self Only"},
        {"name": "Wizard Eye", "cn": 8, "type": "Line of Sight (12\")"},
    ],
    "Summoner": [
        {"name": "Control Demon", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Imp", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Leap", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Plague of Insects", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Planar Tear", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Plane Walk", "cn": 10, "type": "Self Only"},
        {"name": "Possess", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Summon Demon", "cn": 12, "type": "Touch"},
    ],
    "Thaumaturge": [
        {"name": "Banish", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Blinding Light", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Circle of Protection", "cn": 12, "type": "Touch"},
        {"name": "Destroy Undead", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Dispel", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Heal", "cn": 8, "type": "Line of Sight (6\")"},
        {"name": "Miraculous Cure", "cn": 16, "type": "Out of Game (A)"},
        {"name": "Shield", "cn": 10, "type": "Line of Sight (sight)"},
    ],
    "Witch": [
        {"name": "Animal Companion", "cn": 10, "type": "Out of Game (B)"},
        {"name": "Brew Potion", "cn": 12, "type": "Out of Game (B)"},
        {"name": "Control Animal", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Curse", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Familiar", "cn": 10, "type": "Out of Game (B)"},
        {"name": "Fog", "cn": 8, "type": "Line of Sight (24\")"},
        {"name": "Mud", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Poison Dart", "cn": 10, "type": "Line of Sight (sight)"},
    ],
    ...
    "Chronomancer": [
        {
            "name": "Slowfall",
            "cn": 8,
            "type": "Reaction / Line of Sight (sight)",
            "source": "Into the Breeding Pits",
        },
    ],
    # --- Forgotten Pacts ---
...
LOST_SPELLS: dict[str, list[dict]] = {
    "Astromancer": [
        ...
        {"name": "Meteor Strike", "cn": 14, "type": "Line of Sight (20\")"},
        {"name": "Misalignment", "cn": 10, "type": "Area Effect"},
        {"name": "Shape Starfire Elemental", "cn": 12, "type": "Line of Sight (6\")"},
        {"name": "Starfall", "cn": 12, "type": "Area Effect"},
        {"name": "Starfire Bolt", "cn": 14, "type": "Line of Sight (sight)"},
    ],
    "Distortionist": [
        {"name": "Break Armour", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Collapse", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Fracture", "cn": 12, "type": "Self Only"},
        {"name": "Implode / Explode", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Misstep", "cn": 10, "type": "Out of Game"},
        {"name": "Whiplash", "cn": 12, "type": "Self Only"},
    ],
    "Fatecaster": [
        {"name": "Blood Wager", "cn": 10, "type": "Self Only"},
        {"name": "Fickle Finger", "cn": 12, "type": "Line of Sight (6\")"},
        {"name": "Mischance", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Scatter", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Serendipity", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "True Gold", "cn": 10, "type": "Out of Game"},
    ],
    "Sonancer": [
        {"name": "Charm", "cn": 8, "type": "Area Effect"},
        {"name": "Humming Blade", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Imbue Instrument", "cn": 10, "type": "Self Only & Out of Game"},
        {"name": "Sound Cloud", "cn": 10, "type": "Self Only"},
        {"name": "Sound Wave", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Steal Voice", "cn": 12, "type": "Line of Sight (sight)"},
    ],
    "Spiritualist": [
        {"name": "Call Wraith", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Command Ethereal", "cn": 12, "type": "Line of Sight (sight)"},
        {"name": "Ethereal Form", "cn": 10, "type": "Self Only"},
        {"name": "Inhabit", "cn": 8, "type": "Line of Sight (sight)"},
...
BLOOD_LEGACY_SPELLS: dict[str, list[dict]] = {
    "Vampire": [
        ...
        {"name": "Hypnotic Gaze", "cn": 14, "type": "Line of Sight (sight)"},
        {"name": "Lifedrain", "cn": 10, "type": "Self Only"},
        {"name": "Mist Form", "cn": 10, "type": "Self Only"},
        {"name": "Psychic Leech", "cn": 10, "type": "Line of Sight (sight)"},
        {"name": "Thralldom", "cn": 8, "type": "Out of Game (A)"},
    ],
    "Fire Giant": [
        {"name": "Comet", "cn": 14, "type": "Line of Sight (16\")"},
        {"name": "Earthquake", "cn": 12, "type": "Area Effect"},
        {"name": "Enflame", "cn": 8, "type": "Line of Sight (sight)"},
        {"name": "Mist Shroud", "cn": 8, "type": "Area Effect"},
        {"name": "Magnify", "cn": 14, "type": "Out of Game (A)"},
        {"name": "Pyre", "cn": 12, "type": "Line of Sight (12\")"},
        {"name": "Raze", "cn": 14, "type": "Line of Sight (12\")"},
...
RANGIFER_SPELLS = [
    {"name": "Antler Shard", "cn": 10, "type": "Line of Sight (18\")"},
    {"name": "Briar", "cn": 8, "type": "Line of Sight (sight)"},
    {"name": "Command Soul", "cn": 12, "type": "Line of Sight (sight)"},
    {"name": "Darkness", "cn": 12, "type": "Area Effect"},
    {"name": "Fire Spice", "cn": 10, "type": "Out of Game"},
    {"name": "Mend", "cn": 10, "type": "Line of Sight (sight)"},
    {"name": "Nature's Cloak", "cn": 10, "type": "Touch"},
    {"name": "Pyre", "cn": 12, "type": "Area Effect"},
    {"name": "Shattering Blow", "cn": 10, "type": "Line of Sight (sight)"},
    {"name": "Sunder", "cn": 8, "type": "Line of Sight (sight)"},
]
...
SOLDIERS: dict[str, dict] = {
    ...
    "raised_skeleton": {
        ...
        "health": 1,
        "gear": "—",
        "notes": "Joins as a temporary member in place of a zombie (Book of Bones). Undead.",
        "description": "Raised in place of a zombie by the Book of Bones as a temporary member of the warband — not a permanent hire, and doesn't count against the soldier or specialist limit. Undead: immune to poison, never wounded, can carry treasure tokens but has no item slots.",
    },
    "raised_armoured_skeleton": {
        ...
        "health": 1,
        "gear": "—",
        "notes": "Joins as a temporary member in place of a zombie (Book of Bones, +30gc Out of Game). Undead; Pack Hunter.",
        "description": "Raised in place of a zombie by the Book of Bones (+30gc Out of Game) as a temporary member of the warband — not a permanent hire, and doesn't count against the soldier or specialist limit. Pack Hunter: activates and moves together with other armoured skeletons in base contact. Undead: immune to poison, never wounded, can carry treasure tokens but has no item slots.",
    },
    "summoned_imp": {
        "name": "Imp",
        "cost": 0,
